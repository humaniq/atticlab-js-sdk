import {Account as BaseAccount} from "js-base";
...
export class AccountResponse {
    ...
    constructor(response) {
        this._baseAccount = new BaseAccount(response.account_id, response.sequence, response.base_fee);
     ...
     */
    baseFeeValue() {
        return this._baseAccount.baseFeeValue();
    }
